...
describe('Auth Middleware', () => {
  ...
  beforeEach(() => {
    ...
    subscriptionService.registerKey('test-enterprise-key-12345', SubscriptionTier.ENTERPRISE, true)
    subscriptionService.registerKey('test-public-key-67890', SubscriptionTier.FREE)
  })
  ...
  describe('requireApiKey', () => {
    ...
    describe('Valid API Keys', () => {
      ...
      it('should attach correct scope for public key', () => {
        ...
        const authReq = mockRequest as AuthenticatedRequest
        expect(authReq.apiKey).toBeDefined()
        expect(authReq.apiKey?.key).toBe('test-public-key-67890')
